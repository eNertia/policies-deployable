# HIPAA Mappings to <%= company_name %> Controls

Below is a list of HIPAA Safeguards and Requirements and the <%= company_name %> controls in place to meet those.

| **Administrative Controls** HIPAA Rule | <%= company_name %> Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | <%= company_name %> Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | <%= company_name %> Control
---------------- | ----------------
